...
namespace api_server
{
  ...
  private:
    ...
    void reparamBspline(ego_planner::UniformBspline &bspline, vector<Eigen::Vector3d> &start_end_derivative, double ratio,
                        Eigen::MatrixXd &ctrl_pts, double &dt, double &time_inc);

    bool refineTrajAlgo(ego_planner::UniformBspline &traj, vector<Eigen::Vector3d> &start_end_derivative,
