...
def generate_launch_description():
    ...
    # use_mockamap (will update to ramdom map later)
    ...
    advanced_param_include = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(
            get_package_share_directory('api_server'), 'launch', 'advanced_param.launch.py')),
        launch_arguments={
            'drone_id': drone_id,
    ...
    traj_server_node = Node(
        ...
        remappings=[
            ...
            ('planning/traj', ['drone_', drone_id, '_planning/traj'])
        ],
        parameters=[
    ...
    simulator_include = IncludeLaunchDescription(PythonLaunchDescriptionSource(
        os.path.join(get_package_share_directory('api_server'), 'launch', 'simulator.launch.py')),
        launch_arguments={
    ...
    # add launch rviz.launch.py
    rviz_include = IncludeLaunchDescription(PythonLaunchDescriptionSource(
        os.path.join(get_package_share_directory('api_server'), 'launch', 'rviz.launch.py'))
    )
