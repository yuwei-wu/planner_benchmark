#ifndef _API_REPLAN_FSM_H_
#define _API_REPLAN_FSM_H_
...
namespace api_server
{
  ...
  private:
    ...
    traj_msgs::msg::MultiTraj multi_bspline_msgs_buf_;
    ...
    void swarmTrajsCallback(const std::shared_ptr<const traj_msgs::msg::MultiTraj> &msg);
    void BroadcastBsplineCallback(const std::shared_ptr<const traj_msgs::msg::SingleTraj> &msg);
